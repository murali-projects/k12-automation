...
public class RelatedPortalPortletTest extends BaseDevWebPageTest {
	...
	public void isRelatedPortalPortletTitlePresent() throws Exception {
		Assert.assertTrue(viewPortalPagesDisplayGroup.doesContentExistInId("relatedPortal", "allPortal_content_text_xpath"));
	...
	public void isRelatedPortalLinkWorking() throws Exception {
		Assert.assertTrue(viewPortalPagesDisplayGroup.linkExists("relatedPortal_first_link"));
	}
}	
