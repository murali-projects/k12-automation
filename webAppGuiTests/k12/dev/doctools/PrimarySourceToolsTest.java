...
public class PrimarySourceToolsTest extends BaseDevWebPageTest {

	private String GROUP = "primarysources";
	...
	public void gotoDetailsPage() throws Exception {
		...
		Link firstItemLink = toolsDisplayGroup.getFirstItemInListPortlet();
		firstItemLink.click();
	...
	public void verifyDownload() throws Exception {
		...
		RadioButton downloadPdfRadioButton = toolsDisplayGroup.downloadPdfRadioButton;
		assertTrue(downloadPdfRadioButton.isPresent());
		assertFalse(downloadPdfRadioButton.isChecked(), "should not be checked");
		downloadPdfRadioButton.click();
		assertTrue(downloadPdfRadioButton.isChecked(), "should be checked now");
	...
	public void verifyEmail() throws Exception {
		...
		RadioButton emailDialogFormatTexthtmlRadioButton = toolsDisplayGroup.emailDialogFormatTexthtmlRadioButton;
		assertTrue(emailDialogFormatTexthtmlRadioButton.isPresent());
		assertTrue(emailDialogFormatTexthtmlRadioButton.isChecked(), "should be checked by default");
		
		RadioButton emailDialogFormatPdfRadioButton = toolsDisplayGroup.emailDialogFormatPdfRadioButton;
		assertTrue(emailDialogFormatPdfRadioButton.isPresent());
		assertFalse(emailDialogFormatPdfRadioButton.isChecked(), "should not be checked");
		emailDialogFormatPdfRadioButton.click();
		assertTrue(emailDialogFormatPdfRadioButton.isChecked(), "should be checked now");
