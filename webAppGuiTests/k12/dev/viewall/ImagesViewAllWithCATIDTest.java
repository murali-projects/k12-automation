...
public class ImagesViewAllWithCATIDTest extends BaseDevWebPageTest {
	...
	public ImagesViewAllWithCATIDTest() {
		try {
	...
	public void openViewAllPage() throws Exception {
		imageFullPortlet.openPage("image.catid.portalpage.url");
		imageFullPortlet.checkViewAllLinkIsWorking();
		checkForFirstPage();
	}
...
//	}
	...
	public void checkExplicitCATEntryShowup() throws Exception{
		Assert.assertTrue(imageFullPortlet.doesDocumentIdShowupInOrder("video_viewAll_docId_table_xpath", "", "EJ2210066278", 1));
		Assert.assertTrue(imageFullPortlet.doesDocumentIdShowupInOrder("video_viewAll_docId_table_xpath", "", "EJ2210085055", 2));
	}
