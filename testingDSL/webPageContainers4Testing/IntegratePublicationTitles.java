...
public class IntegratePublicationTitles extends BasePageContainer{

	private String searchTerm;
	public IntegratePublicationTitles(String searchTerm) throws Exception {
		super();
	...
	public boolean verifypublicationTitles(String displayGroup) throws Exception{
		if(checkPublicationTitlesAreDisplayed(displayGroup)){
			List<String> publicationTitlesInAppl = getPublicationTitles(displayGroup);
			return verifyPublicationTitlesWithDB(displayGroup, publicationTitlesInAppl);
		}
		return false;
	}
	...
	private boolean verifyPublicationTitlesWithDB(String displayGroup,
		...
		if(displayGroup.equals("primarysources")){
			displayGroup = "K12-PrimarySources";
		}
