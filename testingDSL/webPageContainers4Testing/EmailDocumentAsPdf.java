...
import webPageElements4Testing.RadioButton; //import webPageElements4Testing.RobotWebBrowser;
import webPageElements4Testing.TextBox;
import webPageElements4Testing.TextLabel;

public class EmailDocumentAsPdf extends BasePageContainer {

	public EmailDocumentAsPdf() throws Exception {
		super();
	}
	...
	public boolean verifyDetailsOfDocumentLink(String displayGroup)
		...
		new Link(properties.get(displayGroup + "_searchResults_xpath")
				+ "[1]/h3/a").click();
		if (linkValue.equals(new TextLabel(properties.get("statistics_detail_document"))
				.getLabelText()))
			return true;
		return false;
	}
	...
	public boolean selectionAvailablity() throws InterruptedException {
