...
public class ViewAllWebsitesOnSearchResultsPage extends BasePageContainer {

	private String VIEW_ALL = "View All";

	public ViewAllWebsitesOnSearchResultsPage() throws Exception {
	}
	...
	public boolean checkViewAllLinkIsWorking(String displayName) throws Exception {
		...
		return (newUrl
				.contains("WebsitesFullListPage/WebsitesFullListWindow"));
	}
