...
public class ViewAllNewsOnSearchResultsPage extends BasePageContainer {

	private String VIEW_ALL = "View All";

	public ViewAllNewsOnSearchResultsPage() throws Exception {
	}
	...
	public boolean checkViewAllLinkIsWorking(String displayName) throws Exception {
		...
		return (newUrl
				.contains("NewsFullListPage/NewsFullListWindow"));
	}
