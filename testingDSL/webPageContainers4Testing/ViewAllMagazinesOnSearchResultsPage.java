...
public class ViewAllMagazinesOnSearchResultsPage extends BasePageContainer {

	private String VIEW_ALL = "View All";

	public ViewAllMagazinesOnSearchResultsPage() throws Exception {
	}
	...
	public boolean checkViewAllLinkIsWorking(String displayName)
		...
		return (newUrl.contains("MagazinesFullListPage/MagazinesFullListWindow"));
	}
	...
	public boolean validateWithDatabase(String displayGroup, String searchTerm)
		...
		List<String> contentFromDB = OceanDatabaseReadFile.readResultsFromFile(
				properties.get("all"), properties.get(displayGroup), properties
						.get("documentTitle"), properties.get("documentTitle"),
				searchTerm);
